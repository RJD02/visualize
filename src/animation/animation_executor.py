...
def generate_animation_css(plan: AnimationPlanV2) -> str:
    ...
    css_parts.append("  --anim-node-fill: #ffffff;")
    css_parts.append("  --anim-node-stroke: #334155;")
    css_parts.append("  --anim-node-highlight-fill: #e2e8f0;")
    css_parts.append("  --anim-node-highlight-stroke: #1f2937;")
    css_parts.append("  --anim-edge-stroke: #475569;")
    css_parts.append("  --anim-edge-active: #0ea5e9;")
    css_parts.append("  --anim-text: #0f172a;")
    css_parts.append("  --anim-font: Inter, ui-sans-serif, system-ui, -apple-system, Segoe UI, Roboto, Helvetica, Arial, sans-serif;")
