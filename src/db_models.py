...
class Session(Base):
    ...
    agent_traces = relationship("AgentTrace", back_populates="session", cascade="all, delete-orphan")
...
class AgentTrace(Base):
    """Captures every agent decision with structured input/output for full observability."""
    ...
    session = relationship("Session", back_populates="agent_traces")
